                        ...
                        <form method="POST" action="{{ route('jadwal.update', $jadwal->id) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="kode_jadwal" name="kode_jadwal" value="{{ $jadwal->kode_jadwal }}" readonly />
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-2">
                                        <input type="time"
                                            ...
                                            id="waktu_mulai" name="waktu_mulai" value="{{ $jadwal->waktu_mulai }}" />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="ruangan" placeholder="Contoh : Ruang 1" value="{{ $jadwal->ruangan }}" />
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('id_layanan') border border-danger @enderror"
                                    ...
                                    <option value="{{ $v->id }}"
                                        {{ $jadwal->id_layanan == $v->id ? 'selected' : '' }}>{{ $v->nama_layanan }}
                                    </option>
                                    @endforeach
                                </select>
