                ...
                <div class="card shadow mb-4">
                    <div class="card-body table-responsive pt-0">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <a href="{{ route('pengeluaran.create') }}" class="btn btn-primary btn-icon-split btn-sm">
                            ...
                            <tbody>
                                @foreach ($pengeluaran as $d)
                                    <tr>
                                        ...
                                        <td>{{ date('d F Y', strtotime($d->tgl_pengeluaran)) }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="deleteConfirm(this); return false;" href="#"
                                                data-id="{{ $d->id }}" data-kode="{{ $d->no_pengeluaran }}"
