                        ...
                        <form method="POST" action="{{ route('penjualan.update', $penjualan->id) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="no_penjualan" name="no_penjualan" value="{{ $penjualan->no_penjualan }}"
                                    readonly />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('keterangan') border border-danger @enderror" id="keterangan" name="keterangan"
                                    rows="5" placeholder="Contoh : Penjualan Barang" style="resize: none">{{ $penjualan->keterangan }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('id_pelanggan') border border-danger @enderror"
                                    ...
                                    <option value="{{ $v->id }}"
                                        {{ $penjualan->id_pelanggan == $v->id ? 'selected' : '' }}>
                                        {{ $v->nama_pelanggan }}
                                    </option>
                                    @endforeach
                                </select>
