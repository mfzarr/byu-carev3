<x-app-layout :title="'Penjualan'">
                            ...
                            <tbody>
                                @foreach ($penjualan as $d)
                                    <tr>
                                        ...
                                        <td>{{ ucwords(str_replace('_', ' ', $d->status_pembayaran)) }}</td>
                                        <td>
                                            <a href="{{ route('penjualan.edit', $d->id) }}"
                                                class="btn btn-success btn-circle">
                                                Edit
                                            </a>

                                            <a href="{{ route('penjualan.detail', $d->id) }}"
                                                class="btn btn-warning btn-circle">
                                                Detail
                                            </a>

                                            <a onclick="deleteConfirm(this); return false;" href="#"
                                                data-id="{{ $d->id }}" data-kode="{{ $d->no_penjualan }}"
    ...
    <script>
        function deleteConfirm(e) {
            ...
            var url3 = "{{ url('penjualan/destroy/') }}";
