                        ...
                        <form method="POST" action="{{ route('barang.update', $barang->id) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="kode_barang" name="kode_barang" value="{{ $barang->kode_barang }}" readonly />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" 
                                        ...
                                        value="{{ number_format($barang->harga_satuan, 0, ',', '.') }}" />
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" 
                                        ...
                                        value="{{ number_format($barang->harga_jual, 0, ',', '.') }}" readonly />
                                </div>
                            ...
                            <div class="mb-3">
                                <img src="{{ asset('assets/images/barang/' . $barang->gambar_barang) }}"
                                    alt="{{ $barang->gambar_barang }}" id="gambar_barang_preview" class="img-fluid"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file"
                                    ...
                                    id="gambar_barang" name="gambar_barang" value="{{ $barang->gambar_barang }}" />
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('id_vendor') border border-danger @enderror"
                                    ...
                                    <option value="" disabled selected> ==>> Pilih Vendor <<== </option>
                                            @foreach ($vendor as $v)
                                    <option value="{{ $v->id }}"
                                        {{ $barang->id_vendor == $v->id ? 'selected' : '' }}>{{ $v->nama_vendor }}
                                    </option>
                                    @endforeach
                                </select>
