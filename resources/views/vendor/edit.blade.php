                        ...
                        <form method="POST" action="{{ route('vendor.update', $vendor->id) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="kode_vendor" name="kode_vendor" value="{{ $vendor->kode_vendor }}" readonly />
                            </div>
                            <div class="mb-3">
                                <label for="nama_vendor" class="form-label">Nama Pegawai</label>
                                <input type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('alamat_vendor') border border-danger @enderror" id="alamat_vendor"
                                    name="alamat_vendor" rows="5" placeholder="Contoh : Jl. Telekomunikasi No. 1" style="resize: none">{{ $vendor->alamat_vendor }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="no_hp" placeholder="Contoh : 081234567890" value="{{ $vendor->no_hp }}" />
                                @if ($errors->has('no_hp'))
                                    <div class="fw-light fs-6 mt-1 text-danger">
                                        {{ $errors->first('no_hp') }}
                                    </div>
