<x-app-layout :title="'Laporan Pengeluaran Kas'">
    ...
    <script>
        ...
        function proses() {
            ...
            var url = "{{ url('laporan/viewdatapengeluarankas/') }}";
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 404) {
                        ...
                        // xpembelian
                        var awalanpembelian = "Laporan Pengeluaran Kas ";
                        ...
                        $('tbody').html("");
                        $.each(response.pengeluarankas, function(key, item) {
                            var no_transaksi = item.no_transaksi;
                            var tanggal = item.tanggal.substring(0, 10); //YYYY-MM-DD
                            $('tbody').append(
                                '<tr>\
