<x-app-layout :title="'Laporan Penjualan'">
    ...
    <script>
        ...
        function proses() {
            ...
            var url = "{{ url('laporan/viewdatapenjualan/') }}";
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 404) {
                        ...
                        // xpenjualan
                        var awalanpenjualan = "Laporan Penjualan ";
                        document.getElementById("xpenjualan").innerHTML = tebal.concat(
                            awalanpenjualan, akhirtebal);
                        ...
                        $.each(response.penjualan, function(key, item) {
                            var no_penjualan = item.no_penjualan;
                            var tgl_penjualan = item.tgl_penjualan.substring(0, 10); //YYYY-MM-DD
                            $('tbody').append(
                                '<tr>\
