                        ...
                        <form method="POST" action="{{ route('pelanggan.update', $pelanggan->id) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="kode_pelanggan" name="kode_pelanggan" value="{{ $pelanggan->kode_pelanggan }}"
                                    readonly />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="no_hp" placeholder="Contoh : 081234567890"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date"
                                    ...
                                    id="tgl_lahir" name="tgl_lahir" value="{{ $pelanggan->tgl_lahir }}" />
